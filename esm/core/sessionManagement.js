...
import { ONE_MINUTE, ONE_HOUR, throttle, UUID, isEmptyObject, objectEntries, addEventListener, addEventListeners, each } from '../helper/tools';
...
export function trackActivity(expandOrRenewSession) {
  var listeners = addEventListeners(window, [DOM_EVENT.CLICK, DOM_EVENT.TOUCH_START, DOM_EVENT.KEY_DOWN, DOM_EVENT.SCROLL], expandOrRenewSession, {
    capture: true,
    passive: true
  });
...
function trackVisibility(expandSession) {
  ...
  var listener = addEventListener(document, DOM_EVENT.VISIBILITY_CHANGE, expandSessionWhenVisible);
