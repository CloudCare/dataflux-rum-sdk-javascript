import { addEventListeners, addEventListener, getRelativeTime, isNumber, includes, each, extend } from '../helper/tools';
import { DOM_EVENT } from '../helper/enums';
import { LifeCycleEventType } from '../helper/lifeCycle';
import { FAKE_INITIAL_DOCUMENT, isAllowedRequestUrl } from './resource/resourceUtils';
